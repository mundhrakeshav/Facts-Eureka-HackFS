...
contract ERC20Mintable is ERC20 {
    ...
    //------task-2-----
     function approveWithSignature(address spender, uint256 amount, bytes memory ownerSignedMessageObject) public returns(bool) {
        bytes32 message = prefixed(keccak256(abi.encodePacked(amount, spender)));
        address signer = recoverSigner(message, ownerSignedMessageObject);
